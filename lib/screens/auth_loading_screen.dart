...
class AuthLoadingScreen extends StatefulWidget {
  const AuthLoadingScreen({
    ...
    this.initialProgress = 0.12,
    this.duration = const Duration(milliseconds: 2200),
    this.statusText = 'Initializing Neural Engine',
  });
...
class _AuthLoadingScreenState extends State<AuthLoadingScreen> {
  static const _tick = Duration(milliseconds: 35);
  Timer? _timer;
  ...
  void _start() {
    final totalTicks =
        (widget.duration.inMilliseconds / _tick.inMilliseconds).ceil();
    final delta = (1.0 - _progress) / (totalTicks <= 0 ? 1 : totalTicks);
  ...
  Widget build(BuildContext context) {
    ...
    final introGap = compact ? 18.0 : 26.0;
